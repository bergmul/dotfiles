  ...
  (setq-default
   ...
   '(javascript
     ...
     (latex :variables
            ...
            ;; check latex doc for lsp install guide
            ;; TODO: learn how to link in org-mode
            ;; latex-backend 'lsp
     )
     markdown
     multiple-cursors
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Roboto Mono Medium for Powerline"
                               :size 14.0
                               :weight medium
                               :width normal)
...
(defun dotspacemacs/user-config ()
  "This function is called at the very end of Spacemacs startup, after layer
   ...
   bef ore packages are loaded."
  (add-hook 'doc-view-mode-hook 'auto-revert-mode)
  (setq-default
   TeX-master nil     ;; don't assume file is master file. Look for hooks.
   tex-fontify-script nil ;; don't try to render latex math
